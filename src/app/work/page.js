  ...
  return (
    <div className='work'>
      ...
      <div className='absolute m-auto top-32 left-0 right-0 grid-main md:grid md:grid-cols-3 md:place-content-center md:gap-4 md:justify-items-center flex-col flex items-center gap-8 2xl:grid-cols-4'>
        <div data-aos="zoom-in" className='gallery-card bg-gray-200 rounded-md drop-shadow-sm flex flex-col gap-8 w-md h-48 p-4'>
        ...
        <div data-aos="zoom-in" className='gallery-card bg-gray-200 rounded-md drop-shadow-sm flex flex-col gap-8 h-48 w-md p-4'>
        ...
        <div data-aos="zoom-in" className='gallery-card bg-gray-200 rounded-md drop-shadow-sm flex flex-col gap-8 h-48 w-md p-4'>
         ...
         <div data-aos="zoom-in" className='gallery-card bg-gray-200 rounded-md drop-shadow-sm overflow-hidden  text-wrap flex flex-col gap-8 h-48 w-md p-4 overflow-auto'>
        ...
        <div data-aos="zoom-in" className='gallery-card bg-gray-200 rounded-md drop-shadow-sm flex flex-col gap-8 w-md h-48 p-4'>
          <h3 className='text-4xl'><a href='https://vaishnavikrishna.netlify.app/' target='blank'>Minimalist Portfolio</a></h3>
          <p>An expression of a mother. </p><br/>
          <span className='absolute bottom-0 flex w-full pr-8 justify-between align-center'>
            <p className='text-xs'><b>9/2025-9/2025</b></p>
            <p>nextJs</p>
          </span>
        </div>
